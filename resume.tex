...
\resumeItem{Senior dev: frontend Design, And Integrate Backend Api's.}
\resumeItemListEnd
\resumeProjectHeading
...
\resumeItemListEnd
\resumeProjectHeading
{\textbf{{Full Stack E-Commerce Mobile App}} $|$ \emph{Javascript, React, Redux, Firebase} $|$ [{\href{https://github.com/Ahmadjajja/E_Commerce_Mobile_App_Frontend}{\underline{Github link}}}]}{}
\resumeItemListStart
...
\resumeItemListEnd
{\textbf{{My All Static landing pages}} $|$ \emph{Html, Css} $|$ [{\href{all-react-static-landing-pages.vercel.app/}{\underline{Live link}}}]}{}
\resumeItemListStart
